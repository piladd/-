...
public class EncryptionService
{
    ...
    // Шифруем приватный ключ с использованием мастер-ключа (MASTER_KEY следует получать из защищенной конфигурации в prod)
    public string EncryptPrivateKey(byte[] privateKey, string masterKey)
    {
        ...
        // Сохраняем IV и зашифрованные данные, разделенные двоеточием
